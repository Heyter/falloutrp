...
--Model Settings--
ENT.Model1 = "models/fallout/gecko.mdl"
ENT.Model2 = "models/fallout/gecko.mdl"
ENT.Model3 = "models/fallout/gecko.mdl"

ENT.AttackAnim = (ACT_GMOD_GESTURE_RANGE_ZOMBIE)

ENT.WalkAnim = (ACT_WALK)
ENT.WalkAnim2 = (ACT_WALK)
