...
hook.Add("HUDPaint", "partyPlayers", function()
    if LocalPlayer().party and !LocalPlayer().partyHidePlayers then
        ...
        // Draw Leader
        if IsValid(LocalPlayer().party.leader) then
            ...
            draw.SimpleText(name, "FalloutRPHUD1", 85, 15, Color(40, 40, 40, 255), false, 0)

            // Health
            for i = 1, 2 do
                draw.SimpleText(health, "FalloutRPHUD1Blur", 220, 15, Color(PEPBOY_COLOR.r, PEPBOY_COLOR.g, PEPBOY_COLOR.b, 200), false, 0)
            end
            draw.SimpleText(health, "FalloutRPHUD1", 220, 15, Color(40, 40, 40, 255), false, 0)
        ...
        for k,v in pairs(LocalPlayer().party.members) do
            if IsValid(v) then
                ...
                draw.SimpleText(name, "FalloutRPHUD1", 85, offset + 15, Color(40, 40, 40, 255), false, 0)

                // Health
                for i = 1, 2 do
                    draw.SimpleText(health, "FalloutRPHUD1Blur", 220, offset + 15, Color(PEPBOY_COLOR.r, PEPBOY_COLOR.g, PEPBOY_COLOR.b, 200), false, 0)
                end
                draw.SimpleText(health, "FalloutRPHUD1", 220, offset + 15, Color(40, 40, 40, 255), false, 0)
