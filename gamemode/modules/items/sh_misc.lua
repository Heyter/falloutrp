...
addMisc(5051, "Engine", "models/props_c17/trappropeller_engine.mdl", 25, 0, true)
addMisc(5052, "Blood Bag", "models/mosi/fallout4/props/aid/bloodbag.mdl", 2, 0, true)
...
addMisc(5056, "Helicopter Weapon", "models/Items/combine_rifle_ammo01.mdl", 5, 0, true)
...
addMisc(5060, "Cementing Paste", "models/props_junk/plasticbucket001a.mdl", 1, 0, true)
addMisc(5061, "Retrieval Tool", "models/weapons/w_models/w_toolbox.mdl", .5, 0, true)
addMisc(5062, "Batteries", "models/items/car_battery01.mdl", .5, 0, true)
addMisc(5063, "Fuel Can", "models/props_junk/gascan001a.mdl", 1, 0, true)
addMisc(5064, "Mr.Whiskers", "models/tsbb/animals/linsang.mdl", 0.5, 0, true)
addMisc(5065, "Mysterious Electronic", "models/mosi/fallout4/electrical/generators/generator01.mdl", 25, 0, true)
addMisc(5066, "Rat Tail", "models/fallout/giantrat_bodycap_tail.mdl", 0.5, 0, true)
addMisc(5067, "Adult Mantis Spine", "models/Gibs/HGIBS_spine.mdl", 0.5, 0, true)
addMisc(5068, "Mantis Nymph Spine", "models/Gibs/HGIBS_spine.mdl", 0.5, 0, true)
addMisc(5069, "Swampy Ghoul Feet", "models/fallout/ghoulferal_bodycap_leftleg.mdl", 0.5, 0, true)
addMisc(5070, "Cazador Stinger", "models/halokiller38/fallout/weapons/melee/chancesknife.mdl", 0.5, 0, true)
