...
addMisc(5004, "Ashtray", "models/clutter/ashtray.mdl", .1, 10)
...
addMisc(5011, "Pitcher", "models/clutter/glasspitcher.mdl", .2, 5)
addMisc(5012, "Plunger", "models/clutter/plunger.mdl", .5, 5)
addMisc(5013, "Rake", "models/clutter/rake.mdl", 2, 10)
addMisc(5014, "Scrap Metal", "models/clutter/scrapmetal.mdl", 2, 30)
...
addMisc(5022, "Bloodied Bag", "models/mosi/fallout4/props/aid/bloodbag.mdl", 1.5, 10)
...
// Mining Materials
addMisc(5028, "Rock", "models/ores/rock_ore.mdl", 0.25, 50)
addMisc(5029, "Copper", "models/ores/copper_ore.mdl", 0.25, 100)
addMisc(5030, "Silver", "models/ores/silver_ore.mdl", 0.25, 250)
addMisc(5031, "Gold", "models/ores/gold_ore.mdl", 0.25, 400)
addMisc(5032, "Crystal", "models/scalpet/crystal.mdl", 0.25, 800)


addMisc(5033, "Wooden stick", "models/gibs/wood_gib01a.mdl", 1, 25)
addMisc(5034, "Sheet metal", "models/props_phx/construct/metal_plate1.mdl", 3, 300)
addMisc(5035, "Pipe", "models/props_canal/mattpipe.mdl", 2, 260)
...
addMisc(5039, "Crystal Shard", "models/scalpet/crystalshar.mdl", 0.25, 350)
addMisc(5040, "Plasma", "models/scalpet/crystalshar.mdl", 0.25, 500)
...
addMisc(5044, "Cloth", "models/cloth/clothwind01.mdl", 0.5, 45)
