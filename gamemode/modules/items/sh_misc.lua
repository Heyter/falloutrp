...
addMisc(5052, "Blood Bag", "models/props_junk/garbage_bag001a.mdl", 2, 50, true)
addMisc(5053, "Painkillers", "               ", .1, 50, true)
addMisc(5054, "Morphine", "               ", .1, 75, true)
...
addMisc(5057, "Radaway", "               ", .5, 50, true)
...
addMisc(5060, "Cementing Paste", "               ", 1, 20, true)
