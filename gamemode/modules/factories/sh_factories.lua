...
FACTORY.Setup = { //Name Of Place = Position, Check Received Every Salary For Owning FACTORY(If Enabled)
	...
	["rp_oldworld_fix"] = {
		...
		["Materials Factory"] = {Pos = Vector(-6182, -3804, -37), Items = {5028, 5029, 5030, 5031, 5033, 5034, 5035, 5044, 5045, 5043, 5042, 5046}, Delay = 120, Description = "The materials factory automatically creates crafting materials and stores them inside the factory itself, waiting for the players of the owning faction to loot them."},
	}
}
