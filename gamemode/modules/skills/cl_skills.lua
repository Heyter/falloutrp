...
function skillSelection(level, skillpoints)
	...
	unlockables:SetTextColor(COLOR_FOREGROUND)
	...
	points:SetTextColor(COLOR_FOREGROUND)
	...
	skillsDescription:SetTextColor(COLOR_FOREGROUND)
	...
	for k,v in ipairs(SKILLS) do
		...
		skillsLabel:SetTextColor(COLOR_FOREGROUND)
