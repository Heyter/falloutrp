...
local images = {
	{image = "falloutrp/pipboy1.jpg", description = " The pipboy contains your player data, inventory, and settings.\n It can be accessed by hitting F4.\n In this tab you can equip, use, and drop items."},
	{image = "falloutrp/pipboy2.jpg", description = " On this screen you can view your hunger, thirst, level, and your rank.\n A player's rank is determined by their number of player kills."},
	{image = "falloutrp/bank.jpg", description = " The bank is very important to use because you DROP all your items when you DIE.\n This is one way you can ensure you will keep your epic loot!"},
	{image = "falloutrp/crafting1.jpg", description = " Crafting is a way to make your own weapons, apparel, aid, ammo, and materials\n However these items may not always have the best stats."},
	{image = "falloutrp/crafting2.jpg", description = " Once you use the crafting table you choose which type of item you want to make.\n Then the items of that type will show if you have the required level.\n You will also see how many materials you still need to craft it."},
	{image = "falloutrp/token.jpg", description = " At the token shop you change your faction or name. You can also create a title.\n WARNING! You only have 1 free faction change!"},
	{image = "falloutrp/factory.jpg", description = " Factories are way to get items and are fought over by all 3 factions.\n There are weapon, apparel, ammo, material, and cap factories.\n You can initiate a 'king of the hill' battle by typing /war."},
	{image = "falloutrp/npc1.jpg", description = " There are many npcs throughout the wasteland, ranging in difficulty and loot.\n Low level npcs include rats, geckos (not fire and green), mantises, etc."},
	{image = "falloutrp/npc2.jpg", description = " The higher level npcs include green and fire geckos, cazadors, and deathclaws.\n It is not recommended to fight these at a lower level!"},
	{image = "falloutrp/rock1.jpg", description = " There are veins scattered all over the map which you mine with a pickaxe.\n You can obtain rock and copper from these."},
	{image = "falloutrp/rock2.jpg", description = " There are also rare veins which you have to keep your eye out for.\n You can mine these and obtain silver, gold, and crystal!"},
	{image = "falloutrp/herb.jpg", description = " You can find herbs and plants around the map which you can scavenge.\n By using them, you might find aid, plant materials, etc."},
	{image = "falloutrp/wood.jpg", description = " You can find wood scraps around the map which you can scavenge.\n By using them, you might find wood materials."},
	{image = "falloutrp/metal.jpg", description = " You can find metal scraps around the map which you can scavenge.\n By using them, you might find scrap metal or even weapons!"},
	{image = "falloutrp/chest.jpg", description = " If you get really lucky you might even come across chests.\n Keep your eyes open! Chests have an abundance of great items.\n Some might be locked and you will need a lockpick."},
	{image = "falloutrp/warning.png", description = " WARNING! The most danagerous enemy in this game is OTHER PLAYERS!\n It is HIGHLY recommended that you turn on PvP protection while you can.\n It is very easy to lose your guard and get killed and lose your items!"},
}
