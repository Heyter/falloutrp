...
local images = {
	...
	{image = "falloutrp/tutorial/rock.jpg", description = " There are veins scattered all over the map which you mine with a pickaxe.\n There are also scavengables and chests."},
