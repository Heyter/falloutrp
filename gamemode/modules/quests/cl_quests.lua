...
function showQuests(giver, active, available)
    ...
    for k,v in ipairs(active) do
        ...
        questLabel:SetTextColor(COLOR_SLEEK_GREEN)
...
function acceptQuestMenu(questGiver, questId, finish)
    ...
    nameTitle:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    descLabel:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    objectivesTitle:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    objectivesLabel:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    rewardsTitle:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    if util.positive(rewards.caps) then
        ...
        rewardsCaps:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    if util.positive(rewards.experience) then
        ...
        rewardsExperience:SetTextColor(COLOR_SLEEK_GREEN)
	...
	if rewards.description then
		...
		rewardsDescription:SetTextColor(COLOR_SLEEK_GREEN)
    ...
    if rewards.items then
        ...
        for k,v in pairs(rewards.items) do
            ...
            if util.positive(v) then
                ...
                amount:SetTextColor(COLOR_SLEEK_GREEN)
