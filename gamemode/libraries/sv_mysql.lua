...
// Be sensitive about keeping this information on a public repository. You should probaby .gitignore this file and only the changes local outside of github
// Ideally you would use environment variables, but that's a little extreme for Garry's Mod
MySQLite_config.Host = "123.fake_host.com" -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
MySQLite_config.Username = "fake_user" -- This is the username to log in on the MySQL server.
								-- contact the owner of the server about the username and password. Make sure it's in quotation marks! (" ")
MySQLite_config.Password = "fake_password" -- This is the Password to log in on the MySQL server,
...
MySQLite_config.Database_name = "fake_dbname" -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
