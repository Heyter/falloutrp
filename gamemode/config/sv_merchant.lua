...
MERCHANTS = {
	["Billy"] = {
		...
		Model = "models/player/ncr/ncr_officer.mdl",
		Sale = {
			[1] = {
				Type = "WEAPONS",
				Items = {},
	...
	["John"] = {
		...
		Angles = Angle(0, 50, 0),
		Model = "models/player/bloocobalt/fo/creatures/ghosts.mdl",
		Sale = {
			[1] = {
				Type = "AID",
				Items = {},
	...
	["Sky"] = {
		...
		Model = "models/player/fallout3/painspikefemaleraider.mdl",
		Sale = {
			[1] = {
				Type = "APPAREL",
				Items = {},
	...
	["Samantha"] = {
		...
		Angles = Angle(0, -23, 0),
		Model = "models/player/fallout3/sadistfemaleraider.mdl",
		Sale = {
			[1] = {
				Type = "MISC",
				Items = {},
