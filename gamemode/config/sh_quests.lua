...
function addQuestGiver(name, position, angles, model, quests, alternateMenu)
	...
	if CLIENT then
		QUESTS.questGivers[name].alternateMenu = alternateMenu
	end
end
...
22,
"Boats On Land",
"Hello there, you sure do look exhausted from running around this wasteland. I used to own an established mechanic shop before everything went to shit. I'll tell you what, if you fetch me the parts, I'll see if I can't make you an airboat that you can ride around in. Working on machines is the only thing that will keep me sane while living in this hell. Some of the things on the list can probably be found in the swamp, others might have to be crafted or scavenged.",
{npc = "npc_x"},
{level = 5},
{experience = 0, caps = 0, description = "A permanent airboat that can be spawned and respawned."},
{[5074] = {1, 1}, [5075] = {2, 1}, [5034] = {3, 2}, [5035] = {4, 1}},
2,
"Return 2 propellor",
1,
"Return 1 airboat seat",
2,
"Return 2 sheet metal",
1,
"Return 1 pipe"
)
